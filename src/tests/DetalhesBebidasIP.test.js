...
const PAGE_MOCK = '/bebidas/15997/in-progress';

describe('Teste da página de Bebidas In Progress', () => {
  test('A tela de bebidas in-progress possui os elementos corretos', () => {
  ...
  test('A tela de bebidas in-progress possui os ingredientes corretos', async () => {
    const {
      getByTestId,
      findAllByTestId,
      getByRole,
