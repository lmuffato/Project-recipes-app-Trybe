...
describe('32 - Redirecione a pessoa usuária, ao clicar no card, para a tela de detalhes, que deve mudar a rota e conter o id da receita na URL', () => {
  it.skip('Caso as receitas sejam de comida a rota deve mudar para a tela de detalhes da receita', () => {
    cy.visit('http://localhost:3000/comidas', {
      onBeforeLoad(win) {
        win.fetch = fetchMock;
      },
  ...
  it.skip('Caso as receitas sejam de bebida a rota deve mudar para a tela de detalhes da receita', () => {
    cy.visit('http://localhost:3000/bebidas', {
      onBeforeLoad(win) {
        win.fetch = fetchMock;
      },
